 ...
 *
 */
public class ConclusionPage extends TestBase {
	  ...
	  // web elements
		...
		public By course_exit = By.xpath("//span[@class='Course_Exit exitTxt']");
		...
		public void shell_no_btn() throws IOException, Exception
		{
			...
			public void  course_exit() throws IOException, Exception
			{
				Thread.sleep(3000);
				CommonMethod.click(driver, course_exit, "course is Closed");			
