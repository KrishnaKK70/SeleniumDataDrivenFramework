...
public class WelcomePage extends TestBase{
    ...
    // web elements
	//public By Bookmarking=  By.xpath("//p[@class='exitInsTxt1 lmsbookmarkTxt']");
	public By Bookmarking=  By.xpath("//li[@class='no_btn']");
	public By openmenu = By.xpath(".//*[@id='gadgetsButn']");
	//public By  openmenu = By.xpath("//*[@id='gadgetsButn']/span");	
	//public By  menubtn = By.xpath("//*[@id='menubtn']/span");
	public By menubtn = By.xpath("//a[@id='menubtn']");
	...
	//actions
	/*
	public void clickOnBookmarking() throws  IOException, InterruptedException
	{
		
			if(CommonMethod.isElementPresent(driver, Bookmarking)) {
				
				CommonMethod.click(driver, Bookmarking_no, "click on no");
	...
	public void clickOnBookmarking() throws  IOException, InterruptedException
	{
		...
		try {			
			CommonMethod.click(driver, Bookmarking, "click on no");
			}catch(Exception e) {
				System.out.println("Bookmarking not present");
				
			}  
	}
		
	public void isWelcomeHeaderTextPresent() throws IOException, InterruptedException{
...
public void verifyPageNo(String pagenumber) throws Exception  {
	...
	public void Logo() throws IOException, Exception
	{
		Thread.sleep(3000);
